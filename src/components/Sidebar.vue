...
<template>
  <div class="w-60 mobile-nav">
    <button
      @click="isOpen = !isOpen"
      :class="isOpen ? 'bg-white': 'bg-gray-800' "
    ...
    >
      <svg
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="w-6 h-6 block lg:hidden text-white"
      >
        <path
    ...
    <div class="flex">
      <div
        ...
        class="flex-col h-screen p-3 w-60 duration-300 bg-gray-800 shadow"
      >
        <div class="space-y-3">
  ...
  <div class="w-60 desktop-nav">
    ...
    <div class="flex">
      <div
        class="flex-col hidden h-screen lg:flex p-3 w-60 duration-300 bg-gray-800 shadow"
      >
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-white">Dashboard</h2>
